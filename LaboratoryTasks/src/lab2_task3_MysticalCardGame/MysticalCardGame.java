package lab2_task3_MysticalCardGame;
...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        SLLNode<Card> dvizi1=firstSorcererCards.getFirst();
        int maxSignificance=0;
        Card maxElement=null;
        SLLNode<Card>temp=null;
        while(dvizi1!=null){
            if(dvizi1.element.significance()>maxSignificance)
            {
                maxSignificance=dvizi1.element.significance();
                maxElement=dvizi1.element;
                temp=dvizi1;
            }
            dvizi1=dvizi1.succ;
        }
        firstSorcererCards.delete(temp);
        SLLNode<Card> dvizi2=secondSorcererCards.getFirst();
        int br=1;
        while(dvizi2!=null){
            if(br==4){
                secondSorcererCards.insertAfter(temp.element,dvizi2);
            }
            br++;
            dvizi2=dvizi2.succ;
        }

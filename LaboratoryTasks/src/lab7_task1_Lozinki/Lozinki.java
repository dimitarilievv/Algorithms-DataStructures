...
public class Lozinki {
    public static void main (String[] args) throws IOException {
        ...
        while(true){
            ...
            if(vlez.equalsIgnoreCase("KRAJ")){
                break;
            }
            String []parts=vlez.split(" ");
            String us=parts[0];
            String pass=parts[1];
            SLLNode<MapEntry<String,String>> curr=tabela.search(us);
            if(curr!=null && curr.element.key.equals(us)&& curr.element.value.equals(pass)){

...
public class twoListsSum {
    ...
    private static SLL<Integer> sum(SLL<Integer> lista1, SLL<Integer> lista2) {
        Stack<Integer> stack1=new Stack<>();
        Stack<Integer> stack2=new Stack<>();
        SLLNode<Integer> dvizi=lista1.getFirst();
        while (dvizi!=null){
            stack1.push(dvizi.element);
            dvizi=dvizi.succ;
        }
        dvizi=lista2.getFirst();
        while (dvizi!=null){
            stack2.push(dvizi.element);
            dvizi=dvizi.succ;
        }

package zad14_listTransformation;
...
public class Transformation {
    ...
    private static void listTransform(SLL<Element> original, SLL<Element> neparni, SLL<Element>parni) {
        SLLNode<Element> dvizi=original.getFirst();
        while (dvizi!=null){
            if(dvizi.element.getId()%2!=0){
                neparni.insertLast(dvizi.element);
            }else{
                parni.insertLast(dvizi.element);
            }
            dvizi=dvizi.succ;
        }
    }

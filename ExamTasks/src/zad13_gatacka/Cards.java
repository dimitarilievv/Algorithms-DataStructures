...
public class Cards
{
    public static void tarotCards(SLL<Card> firstPart,SLL<Card> secondPart)
    {
        ...
        secondPart.insertLast(temp.element);

        dvizi=secondPart.getFirst();
        temp=dvizi;
        secondPart.delete(temp);
        firstPart.insertLast(temp.element);

        dvizi=firstPart.getFirst();
        ...
        secondPart.insertBefore(temp.element,dvizi);
        firstPart.delete(temp);
    }

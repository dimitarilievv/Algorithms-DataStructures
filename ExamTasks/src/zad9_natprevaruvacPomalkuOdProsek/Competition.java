package zad9_natprevaruvacPomalkuOdProsek;
...
public class Competition {
    ...
    public static void competition(SLL<Competitor> prevYearCompetitors, SLL<Competitor> currYearCompetitors) {
        SLLNode<Competitor> dvizi=prevYearCompetitors.getFirst();
        SLLNode<Competitor> temp=null;
        double sum=0;
        while (dvizi!=null){
            sum+=dvizi.element.getPoints();
            dvizi=dvizi.succ;
        }
        double prosek=sum/prevYearCompetitors.length();
        dvizi=currYearCompetitors.getFirst();
        while (dvizi!=null){

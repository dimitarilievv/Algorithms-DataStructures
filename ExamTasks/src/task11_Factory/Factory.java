...
public class Factory {
    ...
    public static void orders(SLL<Order> active, SLL<Order> shipping) {
        ...
        int max=0;
        SLLNode<Order>pomosna=null;
        while(dvizi!=null)
        {
            if(dvizi.element.getPriority()>=max){
                max=dvizi.element.getPriority();
                pomosna=dvizi;
            }
            dvizi=dvizi.succ;
        }
        shipping.insertLast(pomosna.element);
        active.delete(pomosna);
    }
